...
import br.com.fiap.startupfiap.service.RetrofitFactory
...
@Composable
fun CardEndereco(adress: Adress) {
    Card(modifier = Modifier
        ...
        Column(modifier = Modifier
            ...
            Text(text = "CEP: adress.cep")
            Text(text = "Rua: adress.rua")
            Text(text = "Cidade:adress.cidade ")
            Text(text = "Bairro: adress.bairro")
            Text(text = "UF: adrees.uf")
        }
    }
}
...
fun ConsultaScreen(navController: NavController) {
    ...
    var listaAdressState by remember {
        mutableStateOf(listOf<Adress>())
    }
        ...
        Card(
            ...
            Column(
                ...
                Row(verticalAlignment = Alignment.CenterVertically) {
                    ...
                    IconButton(onClick = {
                        val call = RetrofitFactory().getAdressService()
                            .getAdressbyUfCidade(ufState, cidadeState, ruaState)
                        call.enqueue(object : Callback<List<Adress>> {
                            override fun onResponse(
                                call: Call<List<Adress>>,
                                response: Response<List<Adress>>
                            ) {
                                listaAdressState = response.body()!!
                            }
